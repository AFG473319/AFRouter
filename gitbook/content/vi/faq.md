...
Những câu hỏi phổ biến về AFRouter.

---

## AFRouter là gì?

**AFRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**AFRouter dùng chiến lược pricing 3 tầng:**
...
## AFRouter có miễn phí không?

**Có, AFRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của AFRouter.**
...
**AFRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host AFRouter không?

**Có! AFRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.afrouter`)
...
**Có, AFRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.afrouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server AFRouter
...
## Làm thế nào để cập nhật AFRouter?
