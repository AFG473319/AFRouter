...
Common questions about AFRouter.

---

## What is AFRouter?

**AFRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**AFRouter uses a 3-tier pricing strategy:**
...
**Yes, AFRouter itself is 100% free and open source.**
...
**Yes! This is AFRouter's core feature.**
...
**AFRouter tracks quota in real-time for all providers:**
...
## Can I self-host AFRouter?

**Yes! AFRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.afrouter`)
...
**Yes, AFRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.afrouter` (or custom `DATA_DIR`)
- No data sent to AFRouter servers
...
**What AFRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What AFRouter does NOT store:**
