...
**AFRouter 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**是的,AFRouter 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.afrouter`(或自定义 `DATA_DIR`)
- 不会发送数据到 AFRouter 服务器
