...
Preguntas comunes sobre AFRouter.

---

## ¿Qué es AFRouter?

**AFRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**AFRouter usa una estrategia de precios de 3 niveles:**
...
**Sí, AFRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de AFRouter.**
...
**AFRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar AFRouter?

**¡Sí! AFRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.afrouter`)
...
**Sí, AFRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.afrouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de AFRouter
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/AFG473319/AFRouter/issues)
...
3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/afrouter.git
   cd afrouter
